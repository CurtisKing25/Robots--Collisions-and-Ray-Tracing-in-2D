...
void draw() {
  ...
  if (pressed)
  {
    if (wPressed)
    {
      ...
      {
        Matrix Rays = F.times(x);
        strokeWeight(10);
        point((float)P1.get(0,0)+(float)Rays.get(0,0)+(float)(tx+100),(float)P1.get(1,0)+(float)Rays.get(1,0)+(float)(ty+100));
        //ellipse((float)P1.get(0,0)+(float)Rays.get(0,0)+(float)(tx+100),(float)P1.get(1,0)+(float)Rays.get(1,0)+(float)(ty+100),10,10);
        //P1.get(1,0)+Rays.get(1,0);
